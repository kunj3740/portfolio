...
//           <p className="text-purple-400 font-medium mb-6 text-xl md:text-2xl opacity-0 animate-fade-in tracking-wide" style={{ animationDelay: '0.3s' }}>
//             Hello, I'm
//           </p>
//           <h1 
//             ref={textRef} 
//             className="text-5xl md:text-7xl font-bold mb-8 opacity-0"
//           >
//             Kunj Dave
//           </h1>
//           <h2 className="text-2xl md:text-3xl text-gray-300 mb-10 opacity-0 animate-fade-in leading-relaxed" style={{ animationDelay: '0.6s' }}>
//             <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-500">
//               Software Developer
//             </span> | <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-500">
//               Full Stack & GenAI Enthusiast
//             </span> | <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-indigo-400">
//               Problem Solver
//             </span>
//           </h2>
//           <p className="text-gray-400 max-w-3xl mx-auto mb-12 text-lg opacity-0 animate-fade-in leading-relaxed" style={{ animationDelay: '0.9s' }}>
//             Crafting efficient, scalable web applications using modern tools like Next.js and TypeScript, 
//             while integrating intelligent AI-driven features. A 3rd-year B.Tech IT student with a strong 
//             foundation in full-stack development, GenAI technologies, and a passion for solving real-world 
...
//             <a 
//               href="#projects" 
//               className="bg-purple-600 hover:bg-purple-700 text-white font-medium py-3 px-8 rounded-md transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-purple-500/20"
//             >
//               View Projects
//             </a>
//             <a 
//               href="#contact" 
//               className="bg-transparent hover:bg-gray-800 text-purple-400 border-2 border-purple-500 font-medium py-3 px-8 rounded-md transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-purple-500/10"
//             >
//               Contact Me
//             </a>
//           </div>
